...
| 文档 | 内容 | 说明 |
|------|------|------|
| **architecture-review.md** | 架构评审报告 | 从资深架构师角度的全面评审 |
...
| 2 | 引入 LiteLLM Gateway | 补全推理 API、OpenAI 兼容、限流、成本跟踪 |
| 3 | 引入异步 Job 机制 | 部署/扩缩容等长时操作需要异步化 |
| 4 | 增加部署模板市场 | 减少用户重复配置 |
| 5 | 移除 API Gateway | 简化架构，Go Backend 和 LiteLLM 同层级 |
...
| V2.1 | 2026-01-30 | 新增架构评审报告和 Dynamo 核心架构理解指南 |
